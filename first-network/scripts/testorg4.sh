...
# chaincode requests through the  peers to check that org4 was
...
# Query chaincode on peer0., check if the result is 90
echo "Querying chaincode on peer0...."
chaincodeQuery 0 3 90

# Invoke chaincode on peer0.org1, peer0.org2, and peer0.
echo "Sending invoke transaction on peer0.org1 peer0.org2 peer0...."
chaincodeInvoke 0 1 0 2 0 3

# Query on chaincode on peer0., peer0.org2, peer0.org1 check if the result is 80
